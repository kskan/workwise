...
checkAdmin(); //检测是否登录
isAuth(); //是否有权限
$admin=$db->select("id,username,avatar,createtime")->from("user")->all();
		...
		<div class="wrapper preload">
			...
			<div class="main-container">
				<div class="padding-md">
					<ul class="breadcrumb">
						<li><span class="primary-font"><i class="icon-home"></i></span><a href="index.html"> 用户表</a></li>
					</ul>
					...
					<table class="table table-striped" id="dataTable">
						...
						<tbody>
							...
							<tr>
								...
								<?php }?>
								<td>
								<?php  if((!array_search("14",$rulues)&&!array_search("13",$rulues))){?>
