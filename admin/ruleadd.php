...
if($_POST)
{
	...
	$insertid = $db->insert("rule",$data);

	if($insertid)
	{
		showMsg('添加菜单规则成功',config('website').'/admin/rulelist.php');
		exit;
	}else{
		showMsg('添加菜单规则失败',config('website').'/admin/ruleadd.php');
		exit;
	}
							...
							<div class="smart-widget-body">
								<form method="post">
									<div class="form-group">
										...
										<input type="text" required name="url" class="form-control" id="url" placeholder="请输入规则地址">
									</div>
									<div class="form-group">
										...
										<div class="col-lg-10">
											<div class="radio inline-block">
												<div class="custom-radio m-right-xs">
													<input type="radio" checked id="show" name="ismenu" value="1">
											...
											<div class="radio inline-block">
												<div class="custom-radio m-right-xs">
													<input type="radio" id="hidden" name="ismenu" value="0">
